    ...
    subj_data_list_follow=dir(subj_path_data_follow);
        ...
        subj_output_list=dir(subj_path_output);
                ...
                fprintf(ID_file,['addpath(''/nfsd/biopetmri/BACKUP/Users/Marco/3T_Verona/SEL_candidates/code/NIFTI_toolbox/'')\n'...
                    ...
                    'nak_detJ_FLAIR = load_untouch_nii(''' strrep(fullfile(subj_path_output,subj_output_list(3).name,'registration_resampled','FLAIR_T1','Jacobian','nak_detJ_FLAIR.nii.gz'),'\','/') ''')' ';' '\n'...
                    'lesions_prob_base_halfway = load_untouch_nii(''' strrep(fullfile(subj_path_output,subj_output_list(3).name,'registration_resampled','FLAIR_T1','Jacobian','lesion_prob_base_halfway_ANTs.nii.gz'),'\','/') ''')' ';' '\n'...
                    'lesions_prob_foll_halfway = load_untouch_nii(''' strrep(fullfile(subj_path_output,subj_output_list(3).name,'registration_resampled','FLAIR_T1','Jacobian','lesion_prob_foll_halfway_ANTs.nii.gz'),'\','/') ''')' ';' '\n'...
                    'nak_detJ_FLAIR_img = nak_detJ_FLAIR.img;' '\n'...
                    'lesions_mask_base_img = lesions_prob_base_halfway.img > 0.5;' '\n'...                   
                    'lesions_mask_foll_img = lesions_prob_foll_halfway.img > 0.5;' '\n'...
                    'years = ' years ';' '\n'...
                    '\n'...
                    '\n'...
                    '[SEL_' num2str(str2double(subjID_output)) ',' 'CC_SEL_' num2str(str2double(subjID_output)) '] = sel_candidates(nak_detJ_FLAIR_img,lesions_mask_base_img,lesions_mask_foll_img,years);' '\n'...
                    ...
                    'save_untouch_nii(nifti_SEL_' num2str(str2double(subjID_output)) ',''' strrep(fullfile(subj_path_output,subj_output_list(3).name,'registration_resampled','FLAIR_T1','Jacobian','SEL.nii.gz'),'\','/') ''')' ';' '\n'...
                    '\n'...
                    '\n'...
                    ...
                    'save(''' strrep(fullfile(subj_path_output,subj_output_list(3).name,'registration_resampled','FLAIR_T1','Jacobian','num_CC_SEL_FLAIR'),'\','/') ''', ''num_CC_SEL_FLAIR'');' '\n' ...
                    'voxel_SEL = [];\n' ...
                    ...
                    'save(''' strrep(fullfile(subj_path_output,subj_output_list(3).name,'registration_resampled','FLAIR_T1','Jacobian','volume'),'\','/') ''', ''volume'');\n' ...
                    '\n' ...
                    'nak_detJ_T2 = load_untouch_nii(''' strrep(fullfile(subj_path_output,subj_output_list(3).name,'registration_resampled','T2_T1','Jacobian','nak_detJ_T2.nii.gz'),'\','/') ''')' ';' '\n'...
                    'lesions_prob_base_halfway = load_untouch_nii(''' strrep(fullfile(subj_path_output,subj_output_list(3).name,'registration_resampled','T2_T1','Jacobian','lesion_prob_base_halfway_ANTs.nii.gz'),'\','/') ''')' ';' '\n'...
                    'lesions_prob_foll_halfway = load_untouch_nii(''' strrep(fullfile(subj_path_output,subj_output_list(3).name,'registration_resampled','T2_T1','Jacobian','lesion_prob_foll_halfway_ANTs.nii.gz'),'\','/') ''')' ';' '\n'...
                    'nak_detJ_T2_img = nak_detJ_T2.img;' '\n'...
                    'lesions_mask_base_img = lesions_prob_base_halfway.img > 0.5;' '\n'...                   
                    'lesions_mask_foll_img = lesions_prob_foll_halfway.img > 0.5;' '\n'...
                    'years = ' years ';' '\n'...
                    '\n'...
                    '\n'...
                    '[SEL_' num2str(str2double(subjID_output)) ',' 'CC_SEL_' num2str(str2double(subjID_output)) '] = sel_candidates(nak_detJ_T2_img,lesions_mask_base_img,lesions_mask_foll_img,years);' '\n'...
                    'nifti_SEL_' num2str(str2double(subjID_output)) ' = lesions_prob_base_halfway;' '\n'...
                    'nifti_SEL_' num2str(str2double(subjID_output)) '.img = SEL_' num2str(str2double(subjID_output)) ';' '\n'...
                    'save_untouch_nii(nifti_SEL_' num2str(str2double(subjID_output)) ',''' strrep(fullfile(subj_path_output,subj_output_list(3).name,'registration_resampled','T2_T1','Jacobian','SEL.nii.gz'),'\','/') ''')' ';' '\n'...
                    '\n'...
                    '\n'...
                    ... %'copyfile(''' strrep(fullfile(subj_path_output,subj_output_list(3).name,'registration_robust_template','FLAIR_T1','Jacobian','SEL.nii'),'\','/') ''',''' strrep(fullfile(subj_path_output,subj_output_list(3).name,'registration_resampled','Jacobian','SEL_robust_template.nii'),'\','/') ''')' ';' '\n'...
                    ... %'copyfile(''' strrep(fullfile(subj_path_output,subj_output_list(3).name,'registration_robust_template','FLAIR_T1','Jacobian','nak_detJ_FLAIR.nii'),'\','/') ''',''' strrep(fullfile(subj_path_output,subj_output_list(3).name,'registration_resampled','Jacobian','nak_detJ_robust_template.nii'),'\','/') ''')' ';' '
                    'num_CC_SEL_T2 = CC_SEL_' num2str(str2double(subjID_output)) '.NumObjects;' '\n' ...
                    'save(''' strrep(fullfile(subj_path_output,subj_output_list(3).name,'registration_resampled','T2_T1','Jacobian','num_CC_SEL_T2'),'\','/') ''', ''num_CC_SEL_T2'');' '\n' ...
                    'voxel_SEL = [];\n' ...
                    ...
                    '\n' ...
                    'volume = sum(voxel_SEL);' '\n' ... 
                    'save(''' strrep(fullfile(subj_path_output,subj_output_list(3).name,'registration_resampled','T2_T1','Jacobian','volume'),'\','/') ''', ''volume'');' ]);
