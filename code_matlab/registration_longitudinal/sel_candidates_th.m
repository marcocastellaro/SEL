...
% determinanti
function [SEL_base,CC_SEL_base,jacobian_lesions_mask_EJ1_base] = sel_candidates_th(normalized_detJ,normalized_detJ2,lesions_prob_base_img)
...
% di codice
[SEL_base, CC_SEL_base] = dilation_sel_selection_th(jacobian_lesions_mask_EJ1_base,normalized_detJ2,lesions_prob_base_img);
