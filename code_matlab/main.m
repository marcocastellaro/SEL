...
[SEL_4, CC_SEL_4] = sel_candidates(log_detJ_img,lesions_mask_base_img,lesions_mask_foll_img,baseline_date,followup_date);
...
[SEL_27, CC_SEL_27] = sel_candidates(log_detJ_img,lesions_mask_base_img,lesions_mask_foll_img,baseline_date,followup_date);
...
[SEL_128, CC_SEL_128] = sel_candidates(log_detJ_img,lesions_mask_base_img,lesions_mask_foll_img,baseline_date,followup_date);
...
[SEL_298, CC_SEL_298] = sel_candidates(log_detJ_img,lesions_mask_base_img,lesions_mask_foll_img,baseline_date,followup_date);
