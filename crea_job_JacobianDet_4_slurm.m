...
for k=3:length(list)
    ...
    if (~isempty(followup))
                ...
                fprintf(ID_file,['#!/bin/bash\n'...
                    ...
                    'input2_T1=' fullfile(subj_path,followup,'T13DTFE_N4.nii.gz') '\n'...
                    'input1_FLAIR=' fullfile(subj_path,baseline,'3DFLAIR_N4.nii.gz') '\n'...
                    'input2_FLAIR=' fullfile(subj_path,followup,'3DFLAIR_N4.nii.gz') '\n'...
                    'mask1=' fullfile(subj_path,baseline,'CT','BrainExtractionMask.nii.gz') '\n'...
                    'mask2=' fullfile(subj_path,followup,'CT','BrainExtractionMask.nii.gz') '\n'...
                    'lesion_mask1=' fullfile(subj_path,baseline,'nicMS_Lesion','lesions.nii.gz') '\n'...
